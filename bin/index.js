...
const dawudData  = JSON.parse(fs.readFileSync(path.join(__dirname, 'dawud.json'), 'utf8'));
...
if (wantsVersion) {
  console.log('');
  console.log('  sunan-abi-dawud v' + pkg.version);
  console.log('  Total hadiths : ' + dawudData.hadiths.length);
  console.log('  Total chapters: ' + dawudData.chapters.length);
  console.log('');
  process.exit(0);
}
...
if (wantsReact) {
  ...
  const CDN      = 'https://cdn.jsdelivr.net/npm/sunan-abi-dawud@' + pkg.version + '/chapters';
...
`;
  ...
  console.log('');
  console.log('  ✓ Generated: src/hooks/useDawud.js');
  console.log('');
  console.log('  Use in any component:');
  console.log('');
  console.log("    import { useDawud } from '../hooks/useDawud';");
  console.log('');
  console.log('    function MyComponent() {');
  console.log('      const dawud = useDawud();');
  console.log('      if (!dawud) return <p>Loading...</p>;');
  console.log('      return <p>{dawud.get(1).english.text}</p>;');
  console.log('    }');
  console.log('');
  process.exit(0);
}
...
if (wantsHelp || numArgs.length === 0) {
  console.log('');
  console.log('  Sunan Abi Dawud CLI  v' + pkg.version);
  console.log('');
  console.log('  Usage:');
  console.log('    dawud <hadithId>                     Show hadith by global ID');
  console.log('    dawud <chapterId> <hadithId>         Show hadith within a chapter');
  console.log('');
  ...
  console.log('    --react                              Generate useDawud hook in React project');
  console.log('    -h, --help                           Show this help');
  console.log('    -v, --version                        Show version and stats');
  console.log('');
  console.log('  Examples:');
  console.log('    dawud 1                              First hadith');
  console.log('    dawud 2345 -a                        Hadith #2345 in Arabic');
  console.log('    dawud 2345 -b                        Hadith #2345 in both languages');
  console.log('    dawud 23 34                          34th hadith of chapter 23');
  console.log('    dawud --react                        Setup React hook in current project');
  console.log('');
  process.exit(0);
}
...
if (!hadith) { console.error('  Invalid arguments. Run `dawud --help` for usage.'); process.exit(1); }
printHadith(hadith);
